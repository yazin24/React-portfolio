...
const Contact = () => {
  ...
  return (
    <motion.div
      ...
      <div className="flex flex-col justify-center mx-auto md:flex-row bg-white text-cyan-500 font-bold md:w-3/4 m-4 mb-24">
        ...
        <div className="p-8 md:w-1/2">
          <form onSubmit={submitSuccess}>
            <input type="text" placeholder="Name" className="text-xl md:text-2xl p-1 border border-2 rounded-sm w-full mb-2" required/>
            <input type="text" placeholder="Email" className="text-xl md:text-2xl p-1 border border-2 rounded-sm w-full mb-2" required/>
            <input type="text" placeholder="Subject" className="text-xl md:text-2xl p-1 border border-2 rounded-sm w-full mb-4" required/>
            <label className="text-xl md:text-2xl">Message:</label>
            <textarea name="message" id="" cols="20" rows="7" className="text-xl p-1 border border-2 rounded-sm w-full" required></textarea>
