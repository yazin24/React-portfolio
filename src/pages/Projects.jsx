      ...
      >
        <div className="flex flex-col gap-8">
                ...
                <div className="card-front border border-green-700">
                  ...
                  <div className="mt-4 ml-4 text-xs md:text-lg vv">
                  <h2 className="text-black">Fave Company System</h2>
                  
                  <h4 className="text-black text-xs mt-2">Stacks: JAVASCRIPT PHP,LARAVEL, MYSQL, TAILWIND</h4>
                  
                  <a href="https://github.com/yazin24/fave_system" className="text-black text-xs mt-2">
                    Code Here
                  </a>
                  </div>
                </div>
                ...
                <div className="card-front border border-green-700">
                  <div className="border border-green-700 p-4">
                    <video autoPlay muted  className="w-1/2">
